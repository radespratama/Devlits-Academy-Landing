        ...
        <div className="flex justify-between items-center hero-section">
            <div className="w-1/2">
                ...
                <p className="text-white text-md mb-8 describe-course font-light">
                    We provide tons of path skill that you <br /> can choose and focus on
                </p>
                <form onSubmit={submit}>
                    <input type="text" onChange={(e) => setMember(e.target.value)} className="bg-white focus:outline-none border-0 px-6 py-3 w-1/2" value={member} placeholder="Your email address"/>
